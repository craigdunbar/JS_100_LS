// Using the following code, create two classes - Truck
//  and Car
...
// When designing an Object Oriented program, it's common to have multiple classes that perform similar actions. For example, both `Truck` and `Car` use the property `year`.
