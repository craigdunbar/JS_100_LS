...
// after the phrase there should be a single space and the words `Meow meow!`. 
// For example:
...
// The Dogconstructor should take 4 arguments, name, age and status and master
// . Dogs should always have a leg count of 4 and a species of dog
// . Dogs have the same introduce method as any other animal, 
// but they have their own method called greetMaster(), which accepts no arguments 
// and returns Hello (master's name)! Woof, woof!
...
let dog = new Dog("Spot", "6", "excited", "Bob")
