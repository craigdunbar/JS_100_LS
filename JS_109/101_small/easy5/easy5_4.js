...
the parameter will recieve an array 
sort the array
iterate over the array checking the value of each element against
the next one
if they are the same return the value of the matching element
*/
