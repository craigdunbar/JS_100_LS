...
//   { id: 101, movement: "out", quantity: 18 }, ]
# ----------------------------ALGO---------------------------
# since transactions is an array with object elements we can use
filter to return the requested entries
*/
...
//     if (Object.values(obj).includes(101) === true) {
//         console.log(obj);
//         return obj
//     }
// });
...
function transactionsFor(itemID, array) {
    return array.filter(transaction => transaction['id'] === 101)
}
