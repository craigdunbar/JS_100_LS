...
sequence(0, 1000000);    // []
# ----------------------------ALGO---------------------------
# initalise an array of undefined's the length of which is equal to the first 
integer argument
initalise a loop and map the array using the count variable and multiply that
count by the second array argument.
