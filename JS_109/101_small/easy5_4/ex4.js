...
# Input: array
# Output: array element value
# ---------------------------RULES---------------------------
# Explicit: only one duplicate
...
iterate over the given array and add each element to the new
array if the new array doesn't include the element
if it already includes the element return the element
*/
