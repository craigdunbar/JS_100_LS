...
For this exercise, write a function that takes a word and some text 
...
# ----------------------------ALGO---------------------------
as before split the string into an array of words map the array 
and if any word matches the given argument chsngre the text as described above

*/
function searchWord(str1, str2) {
  return str2.split(' ').map(word => {
    if (word.toLowerCase() === str1) {
