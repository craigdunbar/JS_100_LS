...
by enclosing the word in ** on each side and making the word 
uppercase ie **WORD**

# --------------------------PROBLEM--------------------------

# Input: string and sentence
# Output: sentence
# ---------------------------RULES---------------------------
# Explicit: change every instance of word string to **word**
...
# ----------------------------ALGO---------------------------
# we cna use the same idea as previous problem
but instead of counting the instances we change the instances to the **WORD** style
*/
function searchWord(str, sentence) {
    let newArr = []
sentence.split(' ').forEach(word => {
  word.toLowerCase() === str ? newArr.push(`**${str.toUpperCase()}**`) : newArr.push(word);
});
return newArr.join(' ');
}
